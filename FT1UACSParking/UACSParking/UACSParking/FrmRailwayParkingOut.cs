...
namespace UACSParking
{
    public partial class FrmRailwayParkingOut : Baosight.iSuperframe.Forms.FormBase
    {
        ...
        public FrmRailwayParkingOut()
        {
            ...
            railwayLineNO = cmbTrainLine.Text.Equals("A跨 PT55") ?                
                ClsParkingManager.TRAIN_RAILWAYLINE_PT55 : cmbTrainLine.Text.Equals("A跨 PT55B") ?
                ClsParkingManager.TRAIN_RAILWAYLINE_PT55B : cmbTrainLine.Text.Contains("PT57A") ?
        ...
        private void btnTrainLeave_Click(object sender, EventArgs e)
        {
            ...
            UACSUtility.HMILogger.WriteLog(btnTrainLeave.Text, "火车离：" + railwayLineNO, UACSUtility.LogLevel.Info, this.Text, ((IAuthorization)FrameContext.Instance.GetPlugin<IAuthorization>()).GetUserName());
      ...
      private void initializeTrainSize()
      {
        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                ...
                UACSUtility.HMILogger.WriteLog(btnStart.Text, "作业开始：" + tagValue, UACSUtility.LogLevel.Info, this.Text, ((IAuthorization)FrameContext.Instance.GetPlugin<IAuthorization>()).GetUserName());
        ...
        private void btnPause_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                ...
                UACSUtility.HMILogger.WriteLog(btnPause.Text, "作业暂停：" + tagValue, UACSUtility.LogLevel.Info, this.Text, ((IAuthorization)FrameContext.Instance.GetPlugin<IAuthorization>()).GetUserName());
        ...
        private void btnXiaoZhao_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                ...
                UACSUtility.HMILogger.WriteLog(btnTrainLeave.Text, "火车销账：" + tagValue, UACSUtility.LogLevel.Info, this.Text, ((IAuthorization)FrameContext.Instance.GetPlugin<IAuthorization>()).GetUserName());
            }
        }
        ...
        private void btnAutoSelectColi_Click(object sender, EventArgs e)
        {
            ...
            if (dr == DialogResult.OK)
            {
                ...
                UACSUtility.HMILogger.WriteLog(btnTrainLeave.Text, "自动选卷：" + tagValue, UACSUtility.LogLevel.Info, this.Text, ((IAuthorization)FrameContext.Instance.GetPlugin<IAuthorization>()).GetUserName());
            }
        }
