...
namespace UACSParking
{
    ...
    public partial class ParkLaserOut : UserControl
    {
        ...
        /// <param name="xLength"></param>
        /// <param name="yLength"></param>
        /// <param name="carHearDrection"></param>
        public void DrawParksizeFT(int x, int y, int xLength, int yLength, string carHearDrection)
        {
            try
            {
                bitM = new Bitmap(this.pan1.Width, this.pan1.Height);
                ...
                g.DrawRectangle(myPen, n2 + XOffset1, n1 + YOffset1, n3, n4);       //调用Graphics对象的DrawRectangle方法
        ...
        public void CreatePassageWayAreaFT(int x, int y, int xLength, int yLength)
        {
            try
            {
                //x-传给->X y-->Y  
                XRatio = GetRatio(labWidth, xLength);
                YRatio = GetRatio(labHeight, yLength);
                InitializeOffsetXY(x, y);
                pan1.Location = new Point(5, 5);
                pan1.Size = new Size(labWidth, labHeight);
                pan1.BackColor = Color.White;
        ...
        /// <param name="carDiretion"></param>
        public void CreateCarSizeFT(int x, int y, int xLength, int yLength, int carType)
        {
            try
            {
                //x-传给->Y y-->x   换过来
                ...
                {
                    HasCarSize = true;
                    pan2.Location = new Point( n2 + XOffset1,n1 + YOffset1);
                    pan2.Size = new Size(n3, n4);
                    pan2.BackColor = Color.Gold;
                    this.pan1.Controls.Add(pan2);
                }            
            }
        ...
        public void CreateCoilSizeFT(int x, int y, int coilWidth, int coilOutSide, string GrooveNO, bool hasCoil, string coilMatNO, ToolTip toolTip)
        {
            Label lab1 = new Label();
            int n3 = Convert.ToInt32(coilWidth * YRatio);
            int n4 = Convert.ToInt32(coilOutSide * XRatio);
            //中心坐标-高度/2=位置Y,中心坐标-宽度/2=位置X
            int n1 = Convert.ToInt32(Math.Abs(y * YRatio + YOffset));
            int n2 = Convert.ToInt32(Math.Abs(x * XRatio + XOffset));
            //X：画面坐标=|转换坐标（负的）|-车位置偏移   Y： 画面坐标=转换坐标-车位位置偏移
            lab1.Location = new Point(n2 - XOffset1  - n4 / 2,n1 - YOffset1  - n3 / 2);
            lab1.Size = new Size(n4, n3);
            //lab1.Size = new Size(10, 10);
            //字体,生成槽号
            lab1.Font = new System.Drawing.Font("宋体", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            ...
            string ToolTipShow = String.Format("槽索引： {0} \n钢卷号: {1} \n槽坐标X： {2}\n槽坐标Y： {3}", lab1.Text, lab1.Name, y,x);
            toolTip.SetToolTip(lab1, ToolTipShow);
            lab1.MouseClick += lab1_Click;
        ...
        public void CreateCoilSizeFT(int x, int y, int coilWidth, int coilOutSide, string GrooveNO, bool hasCoil, string coilMatNO, ToolTip toolTip, int coilStaus)
        {
            Label lab1 = new Label();
            int n3 = Convert.ToInt32(coilWidth *YRatio );
            int n4 = Convert.ToInt32(coilOutSide * XRatio);
            ...
            int n2 = Convert.ToInt32(Math.Abs(x * XRatio + XOffset));
            //X：画面坐标=|转换坐标（负的）|-车位置偏移   Y： 画面坐标=转换坐标-车位位置偏移
            lab1.Location = new Point(n2 + XOffset1 - pan2.Location.X - n4 / 2, n1 + YOffset1 - pan2.Location.Y - n3 / 2);
            lab1.Size = new Size(n4, n3);
            //lab1.Size = new Size(10, 10);
            //字体,生成槽号
            lab1.Font = new System.Drawing.Font("宋体", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            ...
            if (carType=="0")  //社会车
            {
                foreach (var item in pan1.Controls)
                {
                    if (item is Label)
                    {
                        ...
                        if (labItem.Name == matNO && (coilState == "100" ||coilState == "101"))
                        {
        ...
        /// <param name="coilOutSide"></param>
        public void CreateLaserLocationFT(int x, int y, int coilWidth, int coilOutSide)
        {
            Label lab1 = new Label();
            int n3 = Convert.ToInt32(coilWidth * YRatio);
            int n4 = Convert.ToInt32(coilOutSide * XRatio);
            ...
            int n2 = Convert.ToInt32(Math.Abs(x * XRatio + XOffset));
            //X：画面坐标=|转换坐标（负的）|-车位置偏移   Y： 画面坐标=转换坐标-车位位置偏移
            lab1.Location = new Point(n2 + XOffset1 - pan2.Location.X, n1 + YOffset1 - pan2.Location.Y - n3 / 2);
            lab1.Size = new Size(n4, n3);
            //lab1.Size = new Size(10, 10);
            //字体,生成槽号
            lab1.Font = new System.Drawing.Font("宋体", 12F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
