    ...
    public partial class FrmSaddleMetail : Form
    {
        ...
        private void btnByUsable_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                UACSUtility.HMILogger.WriteLog(btnByUsable.Text, "库位" + saddleInfo.SaddleNo + "标记为可用 ,用户：" + form.UserName, UACSUtility.LogLevel.Warn, this.Text);
                //}
                //else
                //    txtPopupMessage.Text = "输入密码错误！！！";
            }
        ...
        private void btnByStay_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                UACSUtility.HMILogger.WriteLog(btnByStay.Text, "库位" + saddleInfo.SaddleNo + "标记为待判 ,用户：" + form.UserName, UACSUtility.LogLevel.Warn, this.Text);
                //}
                //else
                //    txtPopupMessage.Text = "输入密码错误！！！";
        ...
        private void btnByBlock_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                UACSUtility.HMILogger.WriteLog(btnByBlock.Text, "库位" + saddleInfo.SaddleNo + "标记为封锁 ,用户：" + form.UserName, UACSUtility.LogLevel.Warn, this.Text);
                //}
                //else
                //    txtPopupMessage.Text = "输入密码错误！！！";
