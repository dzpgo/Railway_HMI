...
namespace CONTROLS_OF_REPOSITORIES
{
    public partial class conCraneDisplay : UserControl
    {
        ...
        private void InitCMS(ContextMenuStrip _cms)
        {
            ...
            _cms.Items.Add("显示指令",null,item1_Click);
            //

            _cms.Items.Add( "生成倒垛",null , item2_Click);
        }
        ...
        {
            CONTROLS_OF_PREMIERE.PopCraneComputerOrderSetting frm = new PopCraneComputerOrderSetting();
            frm.CraneNO = craneNO;
            frm.InitTagDataProvide(SaddleBase.tagServiceName);
        ...
        {
            CONTROLS_OF_PREMIERE.PopStockToStock frm = new PopStockToStock();
            frm.CraneNO = craneNO;
            frm.BayNO = "123".Contains(craneNO) ? "A-1" : "C-1";
            frm.ShowDialog(this);
        }
        #endregion
