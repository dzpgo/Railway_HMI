...
{
    public partial class PREMIERE_TESTING_Z21_BAY : FormBase
    {
        public PREMIERE_TESTING_Z21_BAY()
        {
            InitializeComponent();
        }
        ...
        private string bayNO = "Z21";

        private string craneNO_1 = "6_3";
        private string craneNO_2 = "6_2";
        private string craneNO_3 = "6_1";
        ...
        private void PREMIERE_TESTING_6_1_TO_6_3_Load(object sender, EventArgs e)
        {
            try
            {
