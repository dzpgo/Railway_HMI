...
{
    public partial class PREMIERE_TESTING_Z22_BAY : FormBase
    {
        public PREMIERE_TESTING_Z22_BAY()
        {
            InitializeComponent();
        }
        ...
        private long baySpaceX = 385000;
        private long baySpaceY = 33000;
        private int panelWidth;
        private int panelHeight;
        private bool xAxisRight = true;
        private bool yAxisDown = false;
        private string bayNO = "Z22";

        private string craneNO_1 = "6_6";
        private string craneNO_2 = "6_5";
        private string craneNO_3 = "6_4";
        ...
        private void PREMIERE_TESTING_6_4_TO_6_6_Load(object sender, EventArgs e)
        {
            try
            {
