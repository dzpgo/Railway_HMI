...
{
    public partial class SubFrmXiaoZhaoCancel : Baosight.iSuperframe.Forms.FormBase
    {
        public SubFrmXiaoZhaoCancel()
        {
            InitializeComponent();
        }
        ...
        private void btnConfirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else    
                {
                    ...
                    if (myRead.Read())
                    {
                        string sqlText1 = @" UPDATE UACS_TRUCK_STOWAGE_DETAIL SET STATUS = '101' WHERE MAT_NO = '" + txtCoilNo.Text.Trim() + "' AND STOWAGE_ID = '" + txtStowageID.Text.Trim() + "'";
