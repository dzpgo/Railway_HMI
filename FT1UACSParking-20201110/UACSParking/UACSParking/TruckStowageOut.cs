    ...
    public partial class TruckStowageOut : Baosight.iSuperframe.Forms.FormBase
    {
       ...
       // string cartype;       
        ...
        private void Inq_LoadMap(int thestowageId)
        {
            ...
            {
                //框架配载图信息
                string sqlText_LoadMap = @"SELECT A.GROOVEID , A.MAT_NO,C.PICK_NO, A.POS_ON_FRAME, A.X_CENTER, A.Y_CENTER, A.Z_CENTER, A.X_RELETIVE, A.Y_RELETIVE,E.STOCK_NO,  E.LOCK_FLAG, D.NEXT_UNIT_NO, D.STEEL_GRANDID, D.WEIGHT, D.OUTDIA ,D.WIDTH ,D.PACK_FLAG, A.STATUS  FROM UACS_TRUCK_STOWAGE_DETAIL A ";
