...
{
    public partial class TruckStowageIn : Baosight.iSuperframe.Forms.FormBase
    {
       ...
       // bool hasSetColumn_PT = false;
        ...
        #region 查询
        //private void comb_ParkingNO_SelectedValueChanged(object sender, EventArgs e)
        //{
        //    if (!comb_ParkingNO.Text.Contains('Z'))
        //        return;
        //    isStowage = false;
        ...
        private void RefreshHMI()
        {
            ...
            //刷新激光扫描图像数据 
            LoadLaserInfo(comb_ParkingNO.Text.Trim(), parkLaserOut1);
            //刷新指令表
