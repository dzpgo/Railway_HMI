...
namespace UACSParking
{
    ...
    public partial class SelectCoilForm : Form
    {
        ...
        private void BindMatStock(string packing, string planNo = "")
        {
            ...
            long XMax = 400000;
            long XMin = 400000;
            if (packing == "Z53A1" || packing == "Z53A2"||packing == "Z53B1" || packing == "Z53B2")
            {
                //max  392292 392271
                //min 250499
                XMax = 394000;
            ...
            if (packing == "Z52A1" || packing == "Z52A2"||packing == "Z52B1" || packing == "Z52B2")
            {
                //XMax 450818 450778
                //min  308901 308901
                XMax = 451000;
            ...
            if (packing == "Z51A1" || packing == "Z51A2" || packing == "Z51B1" || packing == "Z51B2")
            {
                //max    451376 451404
                //min 309490
                XMax = 451600;
