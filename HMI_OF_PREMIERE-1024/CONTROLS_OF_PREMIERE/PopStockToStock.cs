...
namespace CONTROLS_OF_PREMIERE
{
    public partial class PopStockToStock : Form
    {
        ...
        {
            lstBoxInfo.Text += "当前跨别：A-1，倒垛行车：" + CraneNO+ "\r\n";
        }
        #region 数据库连接
        ...
        private void txt_FromStock_TextChanged(object sender, EventArgs e)
        {
            ...
            //获取库位信息
            if ((stockFrom.Contains('-') && stockFrom.Length == 5) || (stockFrom.Contains("FT11") && stockFrom.Length == 8))
            {
                string str1;
                string str2;
                string stockNO;
        ...
        private void txt_ToStock_TextChanged(object sender, EventArgs e)
        {
            ...
            if ((stockTo.Contains('-') && stockTo.Length == 5) || (stockTo.Contains("FT11") && stockTo.Length == 8))
            {
                string str1;
                string str2;
                string stockNO;
