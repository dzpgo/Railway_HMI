...
{
    public partial class PREMIERE_TESTING_C_BAY : FormBase
    {
        public PREMIERE_TESTING_C_BAY()
        {
            InitializeComponent();
        }
        ...
        private long baySpaceY = 40000;
        private int panelWidth;
        private int panelHeight;
        private bool xAxisRight = true;
        private bool yAxisDown = true;
        private string bayNO = "C";

        private string craneNO_1="3_4";
        private string craneNO_2="3_5";
